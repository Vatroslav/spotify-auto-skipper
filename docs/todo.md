...
- [x] **Mapping issues lista prijavljuje pjesme kojima mapiranje radi** — DONE (v3.20.2)
  ...
  Izmjereno na produ pri deployu: lista 55 → 23 (prozor 30 dana), 32 ispala, nijedan novi. Ispali su i `Nebula Orionis - Regeneration Process` (prihvatni kriterij) i `Windir - Soknardalr`. Ono što je ostalo su stvarni mismatchevi naziva — `Hallways Of Enchanted Ebony` vs `... - 2016 - Remaster`, `Like Falling Leaves` vs `... - Remastered`, `Grey-Haired Steppe` vs `... - Сивий Степ`. Trajanje: 12.6 s prvi render nakon restarta (gradi indeks), 1.8 s svaki sljedeći; frontend za to vrijeme pokazuje "Checking candidates against Last.fm...".
